...
<div class="container">
            <form class="form-horizontal" role="form" action="fRegister.php" method="post">
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-9">
                         <input type="text" id="contact"  name="contact" placeholder="Contact" class="form-control" autofocus>
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-9">
                         <input type="text" id="department"  name="department" placeholder="Department" class="form-control" autofocus>                     </div>
                </div>

                <div class="form-group">
                	<label for="project" class="col-sm-3 control-label">Project Discription</label>
                	<textarea  class="col-sm-8" id="project"  name="project" placeholder="Project Decription" class="form-control input-lg" rows="5"></textarea>
                </div>
