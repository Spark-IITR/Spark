                ...
                <table class="table table-striped">
                    ...
                    <tbody id="myTable">
                        <?php 
                             $sql    = "select id,name,email,department,college,year,spriority1,spriority2,spriority3,cgpa from student where spriority1!=0 or spriority2!=0 or spriority3!=0";
